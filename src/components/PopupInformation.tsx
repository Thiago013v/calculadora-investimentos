...
export function PopupInformation({ closePopup, popup }: PopupInformationType) {
  ...
  return (
    <div
      className={`carousel w-[70%] md:w-[50%] h-[60%] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-background z-10  rounded-lg ${popup ? "visible opacity-100 transition-all duration-300 flex flex-row" : "invisible opacity-0 transition-all duration-300"}`}
    >
